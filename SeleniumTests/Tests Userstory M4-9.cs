...
namespace SeleniumTests
{
    ...
    public class Userstory_M4_9 : TestInitialize
    {
        ...
        //T_M4-9_F02_B_001
        {
            ...
            TestTools.Element_Klicken(ObjektIDs_FragebogenManagement.Kategorie_Anlegen_Button, driver);
            Assert.AreEqual(Fehlermeldung.Fragen_Kategorie_Hinzufügen_Fehlermeldung, TestTools.Label_Text_Zurückgeben(ObjektIDs_FragebogenManagement.Kategorie_hinzufügen_Seite_Fehlermeldung, driver));

            TestTools.Daten_In_Textbox_Eingeben("Lecker", ObjektIDs_FragebogenManagement.Kategorie_Formulieren_Textbox, driver);
            Assert.AreEqual(false,TestTools.Fehlermeldung_Sichtbarkeitsprüfung(ObjektIDs_FragebogenManagement.Kategorie_hinzufügen_Seite_Fehlermeldung,driver));

            //Variante AGB Fußzeile
            TestTools.AGBFußzeile(driver);

            //Variante Datenschutz Fußzeile
            TestTools_Userstory_M4_9.Fragebogen_Kategorie_Hinzufügen_Inkl_Kategoriename_Eingeben(driver);
