...
namespace SeleniumTests
{
    ...
    public class Userstory_U1_2 : TestInitialize
    {
        ...
        //T_U1-2_ALF_B_00 / T_U1-2_ALF_B_01
        {
            ...
            TestTools.Element_Klicken("loginLinkbutton", driver);
            TestTools.Daten_In_Textbox_Eingeben(LoginDaten.Name1, "Email", driver);
            TestTools.Daten_In_Textbox_Eingeben(LoginDaten.PW1, "Passwort", driver);
