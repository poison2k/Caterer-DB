...
namespace SeleniumTests
{
    ...
    public class Userstory_U1_3 : TestInitialize
    {
        ...
        public void RegistrationsFehler2()
        {
            ...
            driver.FindElement(By.Id(ObjektIDs.Firmanname)).SendKeys(NutzerDaten.NutzerDaten_Firmenname);
            Assert.AreEqual(false, TestTools.Fehlermeldung_Sichtbarkeitsprüfung("Firmenname-error", driver));

            //Organisationsform wählen
            driver.FindElement(By.Id(ObjektIDs.Organisationsform)).SendKeys("Caterer");
            Assert.AreEqual(false, TestTools.Fehlermeldung_Sichtbarkeitsprüfung("Organisationsform-error", driver));

            //Straße befüllen
            driver.FindElement(By.Id(ObjektIDs.Straße_Nr)).Clear();
            driver.FindElement(By.Id(ObjektIDs.Straße_Nr)).SendKeys(NutzerDaten.NutzerDaten_Straße_Nr);
            Assert.AreEqual(false, TestTools.Fehlermeldung_Sichtbarkeitsprüfung("Stra_e-error", driver));

            //PLZ befüllen
            driver.FindElement(By.Id(ObjektIDs.PLZ)).Clear();
            driver.FindElement(By.Id(ObjektIDs.PLZ)).SendKeys(NutzerDaten.NutzerDaten_PLZ);
            Assert.AreEqual(false, TestTools.Fehlermeldung_Sichtbarkeitsprüfung("Postleitzahl-error", driver));

            //Ort befüllen
            driver.FindElement(By.Id(ObjektIDs.Ort)).Clear();
            driver.FindElement(By.Id(ObjektIDs.Ort)).SendKeys(NutzerDaten.NutzerDaten_Ort);
            Assert.AreEqual(false, TestTools.Fehlermeldung_Sichtbarkeitsprüfung("Ort-error", driver));

            //Anrede wählen
            driver.FindElement(By.Id(ObjektIDs.Anrede)).SendKeys("Herr");
            Assert.AreEqual(false, TestTools.Fehlermeldung_Sichtbarkeitsprüfung("Anrede-error", driver));

            //Vorname befüllen
            driver.FindElement(By.Id(ObjektIDs.Vorname)).Clear();
            driver.FindElement(By.Id(ObjektIDs.Vorname)).SendKeys(NutzerDaten.NutzerDaten_Vorname);
            Assert.AreEqual(false, TestTools.Fehlermeldung_Sichtbarkeitsprüfung("Vorname-error", driver));

            //Nachname befüllen
            driver.FindElement(By.Id(ObjektIDs.Nachname)).Clear();
            driver.FindElement(By.Id(ObjektIDs.Nachname)).SendKeys(NutzerDaten.NutzerDaten_Name);
            Assert.AreEqual(false, TestTools.Fehlermeldung_Sichtbarkeitsprüfung("Nachname-error", driver));

            //FunktionAnprechpartner befüllen
            driver.FindElement(By.Id(ObjektIDs.Ansprechpartner)).Clear();
            driver.FindElement(By.Id(ObjektIDs.Ansprechpartner)).SendKeys(NutzerDaten.NutzerDaten_Ansprechpartner);
            Assert.AreEqual(false, TestTools.Fehlermeldung_Sichtbarkeitsprüfung("FunktionAnsprechpartner-error", driver));

            //Telefon befüllen
            driver.FindElement(By.Id(ObjektIDs.Telefon)).Clear();
            driver.FindElement(By.Id(ObjektIDs.Telefon)).SendKeys(NutzerDaten.NutzerDaten_Telefon);
            Assert.AreEqual(false, TestTools.Fehlermeldung_Sichtbarkeitsprüfung("Telefon-error", driver));

            //Umkreis wählen
            driver.FindElement(By.Id(ObjektIDs.Lieferumkreis)).SendKeys("Bis 30 km");
        ...
        public void RegistrationsFehlerEinverständniss()
        {
            ...
            //Fax befüllen
            driver.FindElement(By.Id(ObjektIDs.Fax)).Clear();
            driver.FindElement(By.Id(ObjektIDs.Fax)).SendKeys(NutzerDaten.NutzerDaten_Telefon);

            //Internetadresse befüllen
            driver.FindElement(By.Id(ObjektIDs.Internet)).Clear();
            driver.FindElement(By.Id(ObjektIDs.Internet)).SendKeys("www.test.test");
