...
var validateCldr = function( path, value, options ) {
	...
	validate( "E_MISSING_CLDR", "Missing GenericRequired CLDR content `{path}`.", value || skipBoolean, {
		path: path
	});
};
...
var validateParameterPresence = function( value, name ) {
	validate( "E_MISSING_PARAMETER", "Missing GenericRequired parameter `{name}`.",
